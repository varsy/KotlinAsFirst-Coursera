...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double {
    val vershok = 4.445 / 100
    return sagenes * 48 * vershok + arshins * 48/3 * vershok + vershoks * vershok
}
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val departureMinutes = hoursDepart * 60 + minutesDepart
    val arrivalMinutes = hoursArrive * 60 + minutesArrive
